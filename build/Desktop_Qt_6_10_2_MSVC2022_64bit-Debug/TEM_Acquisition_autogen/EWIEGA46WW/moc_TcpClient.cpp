...
template <> constexpr inline auto TcpClient::qt_create_metaobjectdata<qt_meta_tag_ZN9TcpClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'stateChanged'
        QtMocHelpers::SignalData<void(TcpClient::ConnectionState)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'dataReceived'
    ...
    QtMocHelpers::UintData qt_enums {
        ...
        QtMocHelpers::EnumData<enum ConnectionState>(16, 16, QMC::EnumFlags{}).add({
...
void TcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->stateChanged((*reinterpret_cast<std::add_pointer_t<TcpClient::ConnectionState>>(_a[1]))); break;
        ...
        case 7: _t->onConnectionTimeout(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TcpClient::*)(TcpClient::ConnectionState )>(_a, &TcpClient::stateChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TcpClient::*)(const QByteArray & )>(_a, &TcpClient::dataReceived, 1))
            return;
...
// SIGNAL 0
void TcpClient::stateChanged(TcpClient::ConnectionState _t1)
{
